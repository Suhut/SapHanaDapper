...
namespace Dapper.Contrib.IduExtensions
{
    /// <summary>
    /// The Dapper.Contrib extensions for Dapper
    /// </summary>
    public static partial class SapHanaMapperExtensions
    {
        /// <summary>
        ...
        private static readonly Dictionary<string, ISqlAdapter> AdapterDictionary
            = new Dictionary<string, ISqlAdapter>
            {
                ...
                ["hanaconnection"] = new SapHanaAdapter()
            };
...
public partial class SapHanaAdapter : ISqlAdapter
{
    public int Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, string tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        var cmd = $"insert into \"{tableName}\" ({columnList}) values ({parameterList})";
        connection.Execute(cmd, entityToInsert);//, transaction, commandTimeout);
        var r = connection.Query("select current_identity_value() as idu FROM DUMMY", transaction: transaction, commandTimeout: commandTimeout).ToList();
